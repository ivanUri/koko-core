...
pub const JsApi = struct {
    ...
    pub const behavior = bridge.accessor(Marquee.getBehavior, Marquee.setBehavior, .{});
    pub const bgColor = bridge.accessor(Marquee.getBgColor, Marquee.setBgColor, .{});
    pub const direction = bridge.accessor(Marquee.getDirection, Marquee.setDirection, .{});
    pub const height = bridge.accessor(Marquee.getHeight, Marquee.setHeight, .{});
    pub const hspace = bridge.accessor(Marquee.getHspace, Marquee.setHspace, .{});
    pub const scrollAmount = bridge.accessor(Marquee.getScrollAmount, Marquee.setScrollAmount, .{});
    pub const scrollDelay = bridge.accessor(Marquee.getScrollDelay, Marquee.setScrollDelay, .{});
    pub const trueSpeed = bridge.accessor(Marquee.getTrueSpeed, Marquee.setTrueSpeed, .{});
    pub const vspace = bridge.accessor(Marquee.getVspace, Marquee.setVspace, .{});
    pub const width = bridge.accessor(Marquee.getWidth, Marquee.setWidth, .{});
};
