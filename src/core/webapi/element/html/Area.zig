...
//! HTMLAreaElement — HTMLHyperlinkElementUtils (same model as HTMLAnchorElement).
...
pub fn getTarget(self: *Area) []const u8 {
...
pub fn getRel(self: *Area) []const u8 {
...
pub const JsApi = struct {
    ...
    pub const href = bridge.accessor(Area.getHref, Area.setHref, .{});
    pub const target = bridge.accessor(Area.getTarget, Area.setTarget, .{});
    pub const origin = bridge.accessor(Area.getOrigin, null, .{});
    pub const protocol = bridge.accessor(Area.getProtocol, Area.setProtocol, .{});
    pub const username = bridge.accessor(Area.getUsername, Area.setUsername, .{});
    pub const password = bridge.accessor(Area.getPassword, Area.setPassword, .{});
    pub const host = bridge.accessor(Area.getHost, Area.setHost, .{});
    pub const hostname = bridge.accessor(Area.getHostname, Area.setHostname, .{});
    pub const port = bridge.accessor(Area.getPort, Area.setPort, .{});
    pub const pathname = bridge.accessor(Area.getPathname, Area.setPathname, .{});
    pub const search = bridge.accessor(Area.getSearch, Area.setSearch, .{});
    pub const hash = bridge.accessor(Area.getHash, Area.setHash, .{});
    pub const rel = bridge.accessor(Area.getRel, Area.setRel, .{});
