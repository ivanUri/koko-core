...
const markdown = @import("../../../core/browser/markdown.zig");
const SemanticTree = @import("../../../core/semantic/SemanticTree.zig");
const interactive = @import("../../../core/browser/interactive.zig");
const structured_data = @import("../../../core/browser/structured_data.zig");
...
fn detectForms(cmd: anytype) !void {
    ...
    const forms_data = try @import("../../../core/browser/forms.zig").collectForms(
        cmd.arena,
        frame.document.asNode(),
        frame,
    );

    try @import("../../../core/browser/forms.zig").registerNodes(forms_data, &bc.node_registry);
...
fn waitForSelector(cmd: anytype) !void {
    ...
    const node = @import("../../../core/browser/actions.zig").waitForSelector(selector_z, timeout_ms, bc.session) catch |err| {
...
//
// LP.handleJavaScriptDialog gives Velora-aware clients a *proactive*
